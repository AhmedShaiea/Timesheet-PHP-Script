      ...
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xs-12 col-md-8">
                <div id="left-header">
                    <div class="row">
                            <div  class="col-xs-6 col-md-2" ><a href="javascript:void(0);" class="btn btn-primary bold">{{ trans('messages.Week') }} <span class="week_number">1</span>-{{ trans('messages.From') }}:</a></div>
